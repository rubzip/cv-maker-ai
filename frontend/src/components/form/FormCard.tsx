            ...
            <div className="flex items-center justify-between p-4 bg-transparent group/header">
                <div className="flex items-center gap-3 flex-1">
                    ...
                    <Input
                        ...
                        className={cn(
                            "max-w-[400px] font-bold text-lg border-none bg-transparent focus-visible:ring-0 px-0 h-auto placeholder:text-muted-foreground/60 hover:placeholder:text-muted-foreground/80 transition-all shadow-none",
